...
public class Consumer01_refuse {
    //普通交换机名称
    ...
    public static void main(String[] argv) throws Exception {
        ...
        channel.queueBind(normalQueue, NORMAL_EXCHANGE, "zhangsan"); System.out.println("等待接收消息.....");
        ...
        boolean autoAck = false; channel.basicConsume(normalQueue, autoAck, deliverCallback, consumerTag -> { });
    }
}
